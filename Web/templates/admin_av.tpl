					...
					<form method="POST">
						...
						<table border="1" width="50%" align="center">
							...
							<tr>
								...
								<tr class="settings_line"><td><b>{"_FLAGS"|lang}:</b></td><td>
									<input type="text" size="8" name="access" id="flags" value="{$input.flags}" />
									<img src="images/server_key.png" alt="{"_FLAGS"|lang}" style="cursor:pointer;" 
										onClick="window.open('include/amxxflags.php?id=flags','Link','width=510,height=670,dependent=yes,resizable=yes');return false;" />
								</td></tr>
